                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>${race.raceName}-(${race.startAge}-${race.endAge})</td>
                                        ...
                                        <td>
                                            <a href="superSsbLock.do?raceid=${race.raceId}" class="btn btn-outline-danger btn-sm">锁定</a>
                                            <a href="superSsbUnlock.do?raceid=${race.raceId}" class="btn btn-outline-success btn-sm">解锁</a>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
