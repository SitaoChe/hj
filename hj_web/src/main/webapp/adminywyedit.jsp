    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">业务员编辑</li>
            </ul>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="adminYwyEdit.do" method="post" name="adminYwyEdit" onsubmit="return verify()">
                                <input type="hidden" name="ywyid" value="${OBJYWY.ywyId}">

                                <div class="form-group row">
                                    <label class="col-sm-3">业务员账号</label>
                                    <div class="col-sm-7">
                                        <input type="text" readonly="readonly" value="${OBJYWY.ywyAccount}" name="ywyaccount" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">业务员密码</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJYWY.ywyPwd}" name="ywypwd" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJYWY.ywyName}" name="ywyname" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">身份证</label>
                                    <div class="col-sm-7">
                                        <input id="idcard" onchange="isidcard()" type="text" value="${OBJYWY.idCard}" name="idcard" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7" >
                                        <input id="phone" onchange="isphone()" type="text" required="required" value="${OBJYWY.phone}" name="phone" class="form-control form-control-success">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:adminYwyEdit.submit();"><input type="submit" value="保存" class="btn btn-primary"></a>
