    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">业务员添加</li>
            </ul>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>业务员添加<h5 style="color:red;">(业务员账号以ywy开头)</h5></h4>
                        </div>
                        <div class="card-body">

                            <form class="form-horizontal" action="adminYwyAdd.do" method="post" name="adminYwyAdd" onsubmit="return verify()">
                                <div class="form-group row">
                                    <label class="col-sm-3">业务员账号</label>
                                    <div class="col-sm-7">
                                        <input type="text" value="ywy" required="required" name="ywyaccount" class="form-control form-control-success">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="ywypwd" required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="ywyname"required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:adminYwyAdd.submit();"><input type="submit" value="添加" class="btn btn-primary"></a>
