                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box">管理员发布的通知</a></h2><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box"><i class="fa fa-angle-down"></i></a>
                        </div>
                            ...
                            <ul class="news list-unstyled">
                                ...
                                <li class="d-flex justify-content-between">
                                    <div class="left-col d-flex">
                                        ...
                                        <div class="title"><strong>管理员001</strong>
                                            <p>报名即将结束！</p>
                                        </div>
                                    </div>
                                ...
                                <li class="d-flex justify-content-between">
                                    <div class="left-col d-flex">
                                        <div class="icon"><i class="icon-rss-feed"></i></div>
                                        <div class="title"><strong>管理员002</strong>
                                            <p>拉丁舞报名将在8月23日开始！</p>
                                        </div>
                                    </div>
                                    <div class="right-col text-right">
