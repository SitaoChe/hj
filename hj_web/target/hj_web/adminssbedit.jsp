                        ...
                        <div class="card-body">
                            ...
                            <form action="adminSsbEdit.do" method="post" name="adminSsbEdit" class="form-horizontal" onsubmit="return verify()">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3">舞种-组别</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJRACE.raceName}" name="racename"  class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">特色组</label>
                                    <div class="col-sm-7">
                                        <input id="startAge" type="text" required="required" value="${OBJRACE.startAge}" name="startage"  class="form-control form-control-success"><span id="messageStartAge"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">年龄</label>
                                    <div class="col-sm-7">
                                        <input id="endAge" type="text" required="required" value="${OBJRACE.endAge}" name="endage" class="form-control form-control-success"><span id="messageEndAge"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">报名时间</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJRACE.startTime}" name="starttime"  class="form-control form-control-success" class="Wdate" onclick="WdatePicker()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">报名结束</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJRACE.endTime}" name="endtime" class="form-control form-control-success" class="Wdate" onclick="WdatePicker()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">比赛开始时间</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJRACE.startRace}" name="startrace"  class="form-control form-control-success" class="Wdate" onclick="WdatePicker()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">报名费</label>
                                    <div class="col-sm-7">
                                        <input type="text" id="gradeNum" required="required" value="${OBJRACE.money}" name="money" class="form-control form-control-success"><span id="messageGradeNum"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
