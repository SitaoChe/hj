    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">赛事添加</li>
            </ul>
        </div>
    </div>
    <section>
                        ...
                        <div class="card-body">
                            ...
                            <form action="adminSsbAdd.do" method="post" name="adminSsbAdd" class="form-horizontal" onsubmit="return verify()">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text"  required="required" name="starttime" class="form-control form-control-success" class="Wdate" onclick="WdatePicker()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">报名结束</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" name="endtime"  class="form-control form-control-success" class="Wdate" onclick="WdatePicker()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" id="gradeNum" required="required" name="money" class="form-control form-control-success"><span id="messageGradeNum"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:adminSsbAdd.submit();"><input type="submit" value="添加赛事" class="btn btn-primary"></a>
