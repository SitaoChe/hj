    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">参赛单位添加</li>
            </ul>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>参赛单位添加<h5 style="color:red;">(参赛单位账号以bmd开头)</h5></h4>
                        </div>
                        <div class="card-body">

                            <form class="form-horizontal" action="adminBmdAdd.do" method="post" name="adminBmdAdd" onsubmit="return verify()">
                                <div class="form-group row">
                                    <label class="col-sm-3">参赛单位账号</label>
                                    <div class="col-sm-7">
                                        <input type="text" value="bmd" required="required" name="bmdaccount" class="form-control form-control-success">
                                        <div style="text-align: center">
                                            <span style="text-align: center;color: #a5adb4">${msg}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="bmdpwd" required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="team" required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="name"required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">身份证</label>
                                    <div class="col-sm-7">
                                        <input id="idcard" onchange="isidcard()" type="text" name="idcard" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">地址</label>
                                    <div class="col-sm-7">
                                        <input type="text" name="address" required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">电话</label>
                                    <div class="col-sm-7">
                                        <input id="phone" onchange="isphone()" type="text" name="phone" required="required" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:adminBmdAdd.submit();"><input type="submit" value="添加" class="btn btn-primary"></a>

<%--                                        因为关联了外键admin 提交时一定记得提交adminId--%>
