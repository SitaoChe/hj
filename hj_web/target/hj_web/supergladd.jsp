    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">管理员添加</li>
            </ul>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>管理员添加<h5 style="color:red;">(管理员账号以gl开头)</h5></h4>
                        </div>
                        <div class="card-body">

                            <form class="form-horizontal" action="superGlAdd.do" method="post" name="superGlAdd" >
                                <div class="form-group row">
                                    <label class="col-sm-3">管理员账号</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="gl" class="form-control form-control-success" name="adminaccount">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="" class="form-control form-control-success" name="adminpwd">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:superGlAdd.submit();"><input type="submit" value="添加管理员" class="btn btn-primary"></a>
