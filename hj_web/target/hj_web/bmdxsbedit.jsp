    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">选手编辑</li>
            </ul>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="bmdXsbEdit.do" method="post" name="bmdXsbEdit" class="form-horizontal" onsubmit="return verify()">
...
<%--                                    <div class="col-sm-7">--%>
<%--                                        <input type="text" required="required" value="${OBJUSER.userAccount}" name="useraccount"  class="form-control form-control-success">--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                                <div class="form-group row">--%>
<%--                                    <label class="col-sm-3">密码</label>--%>
<%--                                    <div class="col-sm-7">--%>
<%--                                        <input type="text" required="required" value="${OBJUSER.userPwd}" name="userpwd" class="form-control form-control-success">--%>
<%--                                    </div>--%>
<%--                                </div>--%>
                                <div class="form-group row">
                                    <label class="col-sm-3">男选手</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJUSER.boyName}" name="boyname" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">女选手</label>
                                    <div class="col-sm-7">
                                        <input type="text"  value="${OBJUSER.girlName}" name="girlname" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">手机号</label>
                                    <div class="col-sm-7">
                                        <input id="phone" onchange="isphone()" value="${OBJUSER.phone}" type="text" required="required" name="phone" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">身份证</label>
                                    <div class="col-sm-7">
                                        <input id="idcard" onchange="isidcard()" type="text" required="required" value="${OBJUSER.userIdCard}" name="useridcard" class="form-control form-control-success">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3">地址</label>
                                    <div class="col-sm-7">
                                        <input type="text" required="required" value="${OBJUSER.region}" name="region" class="form-control form-control-success">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-7 offset-sm-3">
                                        <a href="javascript:bmdXsbEdit.submit();"><input type="submit" value="保存信息" class="btn btn-primary"></a>
